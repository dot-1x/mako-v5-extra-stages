...
static char g_sStagesList[TOTALSTAGE][256] = {"EXTREME II", "ZEDDYS", "RMZS", "HELLZ", "ZOMBIEDEN", "RACE"}; // insert stage name here
static int g_iStageButtonId[TOTALSTAGE] = {140676, 100003, 100002, 100000, 100001, 100004}; // insert button hammerid here, the index must match of stage name

ArrayList g_aStageList, g_aWinner;
Menu g_mVoteMenu;
bool g_bStageOnCD[TOTALSTAGE], g_bIsRevote = false, g_bMakoVote = false, g_bOneStageLeft = false, g_bIsRaceMode = false;
...
public void OnMapStart()
{
	...
	PrecacheSound("music/zeddy/propanefullsong.mp3", true);
	PrecacheSound("music/zeddy/watercolormako.mp3", true);
	PrecacheSound("music/zeddy/the_qemists_no_more.mp3", true);
	PrecacheSound("music/zeddy/showdownmako.mp3", true);
	...
	AddFileToDownloadsTable("sound/music/zeddy/propanefullsong.mp3");
	AddFileToDownloadsTable("sound/music/zeddy/watercolormako.mp3");
	AddFileToDownloadsTable("sound/music/zeddy/the_qemists_no_more.mp3");
	AddFileToDownloadsTable("sound/music/zeddy/showdownmako.mp3");
